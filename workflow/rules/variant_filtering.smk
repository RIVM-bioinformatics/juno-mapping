rule filter_af:
    ...
    message: "Marking minority variants for {wildcards.sample}"
    container:
...
rule FilterMutectCalls:
    ...
    message: "Marking low confidence variants for {wildcards.sample}, based on FilterMutectCalls microbial mode"
    container:
